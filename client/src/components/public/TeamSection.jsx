...
import { Users, Zap, Award, Calendar, ArrowRight, Loader2 } from 'lucide-react';
import { teamAPI } from '../../api';
import ScrollReveal, { StaggerContainer, StaggerItem } from './ScrollReveal';

const stats = [
  { icon: Users, label: '团队成员', value: '8' },
  { icon: Calendar, label: '成立时间', value: '2025.11' },
  { icon: Award, label: '合作大厂', value: '4+' },
  { icon: Zap, label: '产出文章', value: '500+' },
];
        ...
        <ScrollReveal>
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-main mb-3">
              <span className="gradient-text font-mono">&gt;</span> 团队介绍
            </h2>
            <p className="text-muted max-w-2xl mx-auto leading-relaxed">
              团队于 2025年11月12日 成立，由 8 名充满激情的成员组成。
            </p>
          </div>
        </ScrollReveal>
